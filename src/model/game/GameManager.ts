...
export default class GameManager {
    ...
    private static _gameList = [
        ...
        new Game('Thunderstore Dev', 'ThunderstoreDev', 'ThunderstoreBeta',
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "632360"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "ThunderstoreBeta.jpg",
        ...
        new Game('Risk of Rain 2 Dedicated Server', 'RiskOfRain2', 'RiskOfRain2Server',
            ...
            'https://thunderstore.io/c/riskofrain2/api/v1/package-listing-index/', EXCLUSIONS,
            [new StorePlatformMetadata(StorePlatform.STEAM, "1180760"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "RiskOfRain2.jpg",
        ...
        new Game('GTFO', 'GTFO', 'GTFO',
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "493520"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "GTFO.jpg",
        ...
        new Game('TaleSpire', 'TaleSpire', 'TaleSpire',
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "720620"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "TaleSpire.jpg",
        ...
        new Game("ROUNDS", "ROUNDS", "ROUNDS",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1557740"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "ROUNDS.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX),
        ...
        new Game("Mechanica", "Mechanica", "Mechanica",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1226990"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Mechanica.jpg",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX),
        ...
        new Game("Muck", "Muck", "Muck",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1625450"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Muck.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX),
        ...
        new Game("BONEWORKS", "BONEWORKS", "BONEWORKS",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "823500"), new StorePlatformMetadata(StorePlatform.OCULUS_STORE),
            new StorePlatformMetadata(StorePlatform.OTHER)], "BONEWORKS.jpg",
        ...
        new Game("Lethal League Blaze", "LethalLeagueBlaze", "LethalLeagueBlaze",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "553310"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "LethalLeagueBlaze.png",
        ...
        new Game("Nickelodeon All‑Star Brawl", "NASB", "NASB",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1414850"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "NASB.jpg",
        ...
        new Game("Starsand", "Starsand", "Starsand",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1380220"), new StorePlatformMetadata(StorePlatform.EPIC_GAMES_STORE, "a774278c0813447c96a76b053cbf73ff"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Starsand.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX),
        ...
        new Game('Potion Craft', 'PotionCraft', 'PotionCraft',
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1210320"),
            new StorePlatformMetadata(StorePlatform.OTHER)], 'PotionCraft.jpg',
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX,
            ['pc']),
        ...
        new Game('Nearly Dead', 'NearlyDead', 'NearlyDead',
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1268900"),
            new StorePlatformMetadata(StorePlatform.OTHER)], 'NearlyDead.png',
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX,
            ['nd']),
        ...
        new Game('AGAINST', 'AGAINST', 'AGAINST',
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1584840"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "AGAINST.jpg",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, []),
        ...
        new Game('Rogue Tower', 'RogueTower', 'RogueTower',
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1843760"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "RogueTower.jpg",
        ...
        new Game('House of the Dying Sun', 'HOTDS', 'HOTDS',
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, '283160'),
            new StorePlatformMetadata(StorePlatform.OTHER)], "HOTDS.jpg",
        ...
        new Game('For The King', 'ForTheKing', 'ForTheKing',
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "527230"), new StorePlatformMetadata(StorePlatform.EPIC_GAMES_STORE, "Discus"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "ForTheKing.png",
        ...
        new Game("Core Keeper", "CoreKeeper", "CoreKeeper",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1621690"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "CoreKeeper.png",
        ...
        new Game("Titanfall 2", "Titanfall2", "Titanfall2",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM_DIRECT, "1237970"), new StorePlatformMetadata(StorePlatform.ORIGIN, ""),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Titanfall2.jpg",
        ...
        new Game("V Rising", "VRising", "VRising",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1604030"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "VRising.jpg",
        ...
        new Game("Hard Bullet", "HardBullet", "HardBullet",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1294760"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "HardBullet.jpg",
        ...
        new Game("Green Hell VR", "GreenHellVR", "GreenHellVR",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1782330"), new StorePlatformMetadata(StorePlatform.OCULUS_STORE),
            new StorePlatformMetadata(StorePlatform.OTHER)], "GreenHellVR.png",
        ...
        new Game("VTOL VR", "VTOL_VR", "VTOL_VR",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "667970"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "VtolVR.jpg",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, []),
        ...
        new Game("Backpack Hero", "BackpackHero", "BackpackHero",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1970580"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "BackpackHero.jpg",
        ...
        new Game("Stacklands", "Stacklands", "Stacklands",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1948280"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Stacklands.jpg",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, []),
        ...
        new Game("Ravenfield", "Ravenfield", "Ravenfield",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "636480"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Ravenfield.jpg",
        ...
        new Game("Aloft", "Aloft", "Aloft",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2051980"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Aloft.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, []),
        ...
        new Game("Chrono Ark", "ChronoArk", "ChronoArk",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1188930"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "ChronoArk.jpg",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, []),
        ...
        new Game("BONELAB", "BONELAB", "BONELAB",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1592190"), new StorePlatformMetadata(StorePlatform.OCULUS_STORE),
            new StorePlatformMetadata(StorePlatform.OTHER)], "BONELAB.jpg",
        ...
        new Game("Trombone Champ", "TromboneChamp", "TromboneChamp",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1059990"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "TromboneChamp.jpg",
        ...
        new Game("Rogue : Genesia", "RogueGenesia", "RogueGenesia",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2067920"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "RogueGenesia.jpg",
        ...
        new Game("Across the Obelisk", "AcrossTheObelisk", "AcrossTheObelisk",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1385380"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "AcrossTheObelisk.png",
        ...
        new Game("ULTRAKILL", "ULTRAKILL", "ULTRAKILL",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1229490"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "ULTRAKILL.jpg",
        ...
        new Game("Ultimate Chicken Horse", "UltimateChickenHorse", "UltimateChickenHorse",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "386940"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "ultimate-chicken-horse.jpg",
        ...
        new Game("Atrio: The Dark Wild", "AtrioTheDarkWild", "AtrioTheDarkWild",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1125390"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "atrio-the-dark-wild.jpg",
        ...
        new Game("Brotato", "Brotato", "Brotato",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1942280"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "brotato.jpg",
        ...
        new Game("Ancient Dungeon VR", "AncientDungeonVR", "AncientDungeonVR",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1125240"), new StorePlatformMetadata(StorePlatform.OCULUS_STORE),
            new StorePlatformMetadata(StorePlatform.OTHER)], "ancient-dungeon-vr.png",
        ...
        new Game("RUMBLE", "RUMBLE", "RUMBLE",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "890550"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "RUMBLE.png",
        ...
        new Game("Dome Keeper", "DomeKeeper", "DomeKeeper",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1637320"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "dome-keeper.jpg",
        ...
        new Game("Skul: The Hero Slayer", "SkulTheHeroSlayer", "SkulTheHeroSlayer",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1147560"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "skul-the-hero-slayer.jpg",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, []),
        ...
        new Game("Sons Of The Forest", "SonsOfTheForest", "SonsOfTheForest",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1326470"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "sons-of-the-forest.jpg",
        ...
        new Game("The Ouroboros King", "TheOuroborosKing", "TheOuroborosKing",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2096510"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "the-ouroboros-king.jpg",
        ...
        new Game("Wrestling Empire", "WrestlingEmpire", "WrestlingEmpire",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1620340"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "wrestling-empire.jpg",
        ...
        new Game("Receiver 2", "Receiver2", "Receiver2",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1129310"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "receiver-2.jpg",
        ...
        new Game("The Planet Crafter", "ThePlanetCrafter", "ThePlanetCrafter",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1284190"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "the-planet-crafter.jpg",
        ...
        new Game("Patch Quest", "PatchQuest", "PatchQuest",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1347970"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "patch-quest.jpg",
        ...
        new Game("Shadows Over Loathing", "ShadowsOverLoathing", "ShadowsOverLoathing",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1939160"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "shadows-over-loathing.jpg",
        ...
        new Game("West of Loathing", "WestofLoathing", "WestofLoathing",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "597220"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "west-of-loathing.jpg",
        ...
        new Game("Sun Haven", "SunHaven", "SunHaven",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1432860"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "sun-haven.jpg",
        ...
        new Game("Wildfrost", "Wildfrost", "Wildfrost",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1811990"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "wildfrost.jpg",
        ...
        new Game("Garfield Kart - Furious Racing", "GarfieldKartFuriousRacing", "GarfieldKartFuriousRacing",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1085510"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "garfield-kart-furious-racing.png",
        ...
        new Game("Techtonica", "Techtonica", "Techtonica",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1457320"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "techtonica.png",
        ...
        new Game("Thronefall", "Thronefall", "Thronefall",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2239150"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "thronefall.png",
        ...
        new Game("We Love Katamari REROLL+ Royal Reverie", "WeLoveKatamariRerollRoyalReverie", "WeLoveKatamariRerollRoyalReverie",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1730700"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "WLKRR.jpg",
        ...
        new Game("Wizard of Legend", "WizardOfLegend", "WizardOfLegend",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "445980"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "WizardOfLegend.jpg",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["wol"]),
        ...
        new Game(
            ...
            [
                ...
                new StorePlatformMetadata(StorePlatform.OTHER)], "BombRushCyberfunk.jpg", 
        ...
        new Game(
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1140150"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "TouhouLostBranchOfLegend.jpg",
         ...
         new Game("Wizard With A Gun", "WizardWithAGun", "WizardWithAGun",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1150530"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "WizardWithAGun.jpg",
        ...
        new Game("Sunkenland", "Sunkenland", "Sunkenland",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2080690"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Sunkenland.jpg",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, []),
        ...
        new Game("Atomicrops", "Atomicrops", "Atomicrops",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "757320"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Atomicrops.jpg",
        ...
        new Game("Erenshor", "Erenshor", "Erenshor",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2382520"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Erenshor.jpg",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, []),
        ...
        new Game("Last Train Outta' Wormtown", "LastTrainOuttaWormtown", "LastTrainOuttaWormtown",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2318480"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "LastTrainOuttaWormtown.png",
        ...
        new Game("DREDGE", "Dredge", "Dredge",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1562430"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Dredge.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, []),
        ...
        new Game("Cities: Skylines II", "CitiesSkylines2", "CitiesSkylines2",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "949230"), new StorePlatformMetadata(StorePlatform.XBOX_GAME_PASS, "ParadoxInteractive.CitiesSkylinesII-PCEdition"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "CitiesSkylines2.png",
        ...
        new Game("Lethal Company", "LethalCompany", "LethalCompany",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1966720"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "LethalCompany.png",
        ...
        new Game("Meeple Station", "MeepleStation", "MeepleStation",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "900010"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "MeepleStation.png",
        ...
        new Game("Void Crew", "VoidCrew", "VoidCrew",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1063420"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "VoidCrew.png",
        ...
        new Game("Sailwind", "Sailwind", "Sailwind",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1764530"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Sailwind.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, []),
        ...
        new Game(
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1623730"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Palworld.png",
        ...
        new Game("Plasma", "Plasma", "Plasma",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1409160"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Plasma.jpg",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, []),
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2881650"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "ContentWarning.png",
        ...
        new Game("Balatro", "Balatro", "Balatro",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2379780"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Balatro.png",
        ...
        new Game(
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1686940"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "BoplBattle.png",
        ...
        new Game("Vertigo 2", "Vertigo2", "Vertigo2",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "843390"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Vertigo2.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, []),
        ...
        new Game("Against the Storm", "AgainstTheStorm", "AgainstTheStorm",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1336490"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "AgainstTheStorm.png",
        ...
        new Game("Lycans", "Lycans", "Lycans",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2596100"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Lycans.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, []),
        ...
        new Game("Castle Story", "CastleStory", "CastleStory",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM_DIRECT, "227860"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "CastleStory.png",
        ...
        new Game(
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2695940"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Panicore.png",
        ...
        new Game("Risk of Rain Returns", "RiskofRainReturns", "RiskofRainReturns",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1337520"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "RiskOfRainReturns.png",
        ...
        new Game("Magicraft", "Magicraft", "Magicraft",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2103140"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Magicraft.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, []),
        ...
        new Game("Another Crab's Treasure", "AnotherCrabsTreasure", "AnotherCrabsTreasure",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1887840"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "AnotherCrabsTreasure.png",
        ...
        new Game("Gladio Mori", "GladioMori", "GladioMori",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2689120"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "GladioMori.png",
        ...
        new Game("Slipstream: Rogue Space", "SlipstreamRogueSpace", "SlipstreamRogueSpace",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2765860"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "SlipstreamRogueSpace.png",
        ...
        new Game("Back to the Dawn", "BacktotheDawn", "BacktotheDawn",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1735700"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "BackToTheDawn.png",
        ...
        new Game("Below the Stone", "BelowTheStone", "BelowTheStone",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1170230"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "BelowTheStone.png",
        ...
        new Game("Gloomwood", "Gloomwood", "Gloomwood",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1150760"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Gloomwood.png",
        ...
        new Game("Betrayal Beach", "BetrayalBeach", "BetrayalBeach",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2643810"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "BetrayalBeach.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [""]),
        ...
        new Game("Arcus Chroma", "ArcusChroma", "ArcusChroma",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1447350"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "ArcusChroma.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [""]),
        ...
        new Game("Deep Rock Galactic: Survivor", "DeepRockGalacticSurvivor", "DeepRockGalacticSurvivor",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2321470"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "DeepRockGalacticSurvivor.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [""]),
        ...
        new Game("Ale & Tale Tavern", "AleAndTaleTavern", "AleAndTaleTavern",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2683150"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "AleAndTaleTavern.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [""]),
        ...
        new Game("Screw Drivers", "ScrewDrivers", "ScrewDrivers",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1279510"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "ScrewDrivers.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [""]),
        ...
        new Game("Nine Sols", "NineSols", "NineSols",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1809540"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "NineSols.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [""]),
        ...
        new Game("Goodbye Volcano High", "GoodbyeVolcanoHigh", "GoodbyeVolcanoHigh",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1310330"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "GoodbyeVolcanoHigh.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [""]),
        ...
        new Game("Supermarket Together", "SupermarketTogether", "SupermarketTogether",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2709570"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "SupermarketTogether.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [""]),
        ...
        new Game("Hades II", "HadesII", "HadesII",
            ...
            new StorePlatformMetadata(StorePlatform.OTHER)], "Hades2.png",
        ...
        new Game("Shapez 2", "Shapez2", "Shapez2",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2162800"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Shapez2.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [""]),
        ...
        new Game("Paquerette Down the Bunburrows", "PaqueretteDownTheBunburrows", "PaqueretteDownTheBunburrows",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "1628610"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "PaqueretteDownTheBunburrows.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [""]),
        ...
        new Game("Hard Time III", "HardTime3", "HardTime3",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "3009850"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "HardTime3.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [""]),
        ...
        new Game("Tank Team", "TankTeam", "TankTeam",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2587450"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "TankTeam.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [""]),
        ...
        new Game("Distance", "Distance", "Distance",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "233610"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Distance.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [""]),
        ...
        new Game("Five Nights at Freddy's: Into the Pit", "FiveNightsAtFreddysIntoThePit", "FiveNightsAtFreddysIntoThePit",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2638370"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "FiveNightsAtFreddysIntoThePit.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [""]),
        ...
        new Game("GoreBox", "GoreBox", "GoreBox",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2027330"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "GoreBox.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [""]),
        ...
        new Game("TCG Card Shop Simulator", "TCGCardShopSimulator", "TCG Card Shop Simulator",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "3070070"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "TCGCardShopSimulator.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [""]),
        ...
        new Game("Old Market Simulator", "OldMarketSimulator", "Old Market Simulator",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2878420"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "OldMarketSimulator.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [""]),
        ...
        new Game("Subterranauts", "Subterranauts", "Subterranauts",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "3075800"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "Subterranauts.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [""]),
        ...
        new Game("SULFUR", "SULFUR", "SULFUR",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2124120"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "SULFUR.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [""]),
        ...
        new Game("WEBFISHING", "WEBFISHING", "WEBFISHING",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "3146520"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "WEBFISHING.png",
        ...
        new Game("STRAFTAT", "STRAFTAT", "STRAFTAT",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2386720"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "STRAFTAT.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [""]),
        ...
        new Game("ATLYSS", "ATLYSS", "ATLYSS",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2768430"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "ATLYSS.png",
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [""]),
        ...
        new Game("Peaks of Yore", "PeaksOfYore", "Peaks of Yore",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "2236070"),
            new StorePlatformMetadata(StorePlatform.OTHER)], "PeaksOfYore.png",
